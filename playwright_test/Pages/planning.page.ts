...
class PlanningPage {
  ...
  async getPlanningPageTitle() {
    await this.commonPage.waitForElement(this.planningPageTitle)
  ...
  async isSetZosmfAttributeChecked() {
    await this.commonPage.waitForElement(this.setZosmf)
  ...
  async getReadyToProceedMessage() {
    await this.commonPage.waitForElement(this.readyToProceedMessage)
  ...
  async validatePlanningStageLocations(runtimeDir: any, workspaceDir: any, extensionDir: any, logDir: any, profileIdentifier: any, jobPrefix: any, jobname: any, javaLocation: any, nodejsLocation: any, zOSMFHost: any, zOSMFPort: any, zOSMFAppID: any) {
    const planningDetailsFilled = await this.fillPlanningPageWithRequiredFields(runtimeDir, workspaceDir, extensionDir, logDir, profileIdentifier, jobPrefix, jobname, javaLocation, nodejsLocation, zOSMFHost, zOSMFPort, zOSMFAppID);
    if (planningDetailsFilled) {
      this.clickValidateLocations();
    } else {
      this.fillPlanningPageWithRequiredFields(runtimeDir, workspaceDir, extensionDir, logDir, profileIdentifier, jobPrefix, jobname, javaLocation, nodejsLocation, zOSMFHost, zOSMFPort, zOSMFAppID);
      this.clickValidateLocations();
    }
  }
