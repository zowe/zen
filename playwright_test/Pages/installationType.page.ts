...
class InstallationTypePage{
  ...
  constructor(page: Page) {
    ...
    this.licenseAgreement = page.locator("//[text()='License Agreement']")
	  this.saveAndClose = page.locator("//[contains(text(),'Save & close')]")
    this.previousStep = page.locator("//[contains(text(),'Previous step')]")
    this.continueToComponentInstallation = page.locator("//[text()='Continue to Components Installation']")
