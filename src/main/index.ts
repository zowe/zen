...
const createWindow = (): void => {
  ...
  ipcMain.handle('zwe-init-certificates', async (event, connectionArgs, installationArgs) => {
    const res = await installActions.runZweInitCertificates(connectionArgs, installationArgs);
    return res;
  });
